  ...
  <div>
      ...
      >
        <template>
          <el-table
              ...
              style="font-size: 13px;left: 1%;border-radius: 5px;" :header-cell-style="{ background: '#E7EAED' }"
              height="650" width="98%"
            ...
            <el-table-column prop="demand_before_status" label="流转前状态" align="center" width="200"
                             :formatter="get_before_status_name"></el-table-column>

            <el-table-column prop="demand_after_status" label="流转后状态" align="center" width="200"
                             :formatter="get_after_status_name"></el-table-column>

            <el-table-column prop="start_time" label="开始时间" align="center" width="200"></el-table-column>

            <el-table-column prop="end_time" label="结束时间" align="center" width="200"></el-table-column>
            ...
            <el-table-column prop="owner_change_push" :formatter="get_change_name" label="是否通知到群" align="center" width="100">
            </el-table-column>
    ...
    <el-dialog :visible.sync="add_config_dialog" show-footer :close-on-press-escape="false"
      ...
      <el-form ref="config_form" :model="config_form" label-width="auto" :rules="config_rules"
        ...
        <el-form-item label="项目名称" prop="tapd_project_id">
        ...
        <el-form-item label="流转前状态" prop="demand_before_status">
          <el-select v-model="config_form.demand_before_status" multiple placeholder="请先选择项目"
        ...
        <el-form-item label="流转后状态" prop="demand_after_status">
          <el-select v-model="config_form.demand_after_status" multiple placeholder="请先选择项目"
                     style="width: 300px;float:left;">
            <el-option v-for="item in demand_status_arr" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="开始时间:"
                      prop="start_time">
          <el-col :span="7">
            <el-date-picker v-model="config_form.start_time" type="datetime" format="yyyy-MM-dd HH:mm:ss"
                            placeholder="选择开始时间" :picker-options="pickerOptions"
                            style="width: 300px;float:left;"></el-date-picker>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="结束时间:"
                      prop="end_time">
          <el-col :span="7">
            <el-date-picker v-model="config_form.end_time" type="datetime" format="yyyy-MM-dd HH:mm:ss"
        ...
        <el-form-item label="处理人变更是否通知群" prop="owner_change_push">
          <el-tooltip style="float:left; margin-top: 10px;">
            <el-switch
                v-model="config_form.owner_change_push"
                active-color="#13ce66"
                inactive-color="#E7EAED"
                active-value="1"
                inactive-value="2">
            </el-switch>
          </el-tooltip>
...
export default {
  ...
  data() {
    return {
      ...
      title: "新增配置",
      delete_id: 0,
      change_list: [{value: "1", label: "是"}, {value: "2", label: "否"}],
      config_form: {
        demand_after_status: [],
        demand_before_status: [],
        webhook_url: "",
        users: [],
        tapd_project_id: "",
        start_time: "",
      ...
      config_rules: {
        ...
        demand_before_status: [{required: true, message: "请选择流转前状态", trigger: "blur"}],
        demand_after_status: [{required: true, message: "请选择流转后状态", trigger: "blur"}]
      },
      pickerOptions: {
        disabledDate(time) {
  ...
  methods: {
    ...
    init() {
      ...
      this.config_form.webhook_url = "";
      this.config_form.start_time = "";
      this.config_form.end_time = "";
      this.config_form.tapd_project_id = "";
      this.config_form.users = [];
      this.config_form.demand_before_status = [];
      this.config_form.demand_after_status = [];
      this.config_form.owner_change_push = "1";
    ...
    get_change_name(raw) {
      let val = null;
      this.change_list.forEach((item) => {
        if (raw.owner_change_push === String(item.value)) {
          val = item.label
        }
      })
      return val
